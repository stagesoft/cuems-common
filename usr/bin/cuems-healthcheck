...
services=("cuems-controller-engine.service" "cuems-node-engine.service" "cuems-videocomposer.service" "jackd-cuems.service" "avahi-daemon.service")
service_issues=0
...
# Network checks can be added per-installation as needed
